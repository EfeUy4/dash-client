...
export const fetchProduct = createAsyncThunk<Product, string>("products/fetchOne", async (id, thunkAPI) => {
	try {
...
export const deleteProduct = createAsyncThunk<string, string>("products/delete", async (id, thunkAPI) => {
	try {
