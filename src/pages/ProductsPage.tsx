...
useEffect(() => {
  if (!hasBeenFetched && !isLoading) {
	...
	// Filter and sort products (internal logic)
	const filteredProducts = useMemo(() => {
		...
		switch (filters.sortBy) {
			...
			default:
				filtered.sort((a, b) => 
					(b.isNewProduct ? 1 : 0) - (a.isNewProduct ? 1 : 0)
				);
				break;
		}
	...
	return (
		<div className="min-h-screen bg-neutral-50">
			{/* Header */}
			<div className="relative bg-gradient-to-br from-primary-950 via-neutral-900 to-primary-950 overflow-hidden">
				...
				<div className="relative container py-10">
					...
					>
						<motion.p
							...
							className="text-primary-100/70 text-sm md:text-base font-medium tracking-wider uppercase mb-4"
						>
							Curated Collection
						</motion.p>
						...
						>
							{filters.category ? (
								...
								<>
									<span className="text-primary-300">All Products</span>
								</>
							)}
						</motion.h1>
						...
						<motion.p
							...
							className="text-primary-100/60 text-sm mt-4"
						>
